            ...
            <div className="p-5 pb-7 flex flex-col gap-3 relative">
                ...
                <div className="mt-1">
                    <div className='flex justify-end gap-3 items-center'>
                        <div className='group p-3 rounded-full hover:bg-gray-100 transition-all duration-300'>
                            <PiTrashLight className='group-hover:text-red-500 transition-all duration-300 cursor-pointer text-xl'/>
                        </div>
                        <div>
                            <label className="inline-flex items-center cursor-pointer">
                            <input type="checkbox" value="" className="sr-only peer" />
                            <div className="relative w-9 h-3 bg-indigo-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border after:content-[''] after:absolute after:top-[-4px] after:start-[-1px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-600"></div>
                            <span className="ml-2 text-sm font-light text-gray-700">required</span>
                            </label>
                        </div>
                    </div>
                </div>
